...
public class ProcessPaymentUseCase {
    ...
    public ProcessPaymentResponse execute(ProcessPaymentRequest request) {
        ...
        BigDecimal requestAmountRounded = request.getAmount().setScale(2, java.math.RoundingMode.HALF_UP);
        BigDecimal orderTotalRounded = order.getTotalAmount().setScale(2, java.math.RoundingMode.HALF_UP);

        if (requestAmountRounded.compareTo(orderTotalRounded) != 0) {
