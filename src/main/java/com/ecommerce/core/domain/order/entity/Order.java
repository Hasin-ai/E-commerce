...
public class Order {
    ...
    private void calculateAmounts() {
        ...
        // Calculate tax (8% for example) - round to 2 decimal places
        this.taxAmount = subtotalAmount.multiply(new BigDecimal("0.08"))
            .setScale(2, java.math.RoundingMode.HALF_UP);

        // Calculate shipping (free for orders over $50) - already has 2 decimal places
        ...
        // Discount amount (default 0) - ensure 2 decimal places
        this.discountAmount = this.discountAmount != null
            ? this.discountAmount.setScale(2, java.math.RoundingMode.HALF_UP)
            : BigDecimal.ZERO.setScale(2, java.math.RoundingMode.HALF_UP);

        // Total amount - round final result to 2 decimal places
